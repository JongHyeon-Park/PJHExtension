...
public class DraggablePanel extends FrameLayout {
    ...
    private static final boolean DEFAULT_ENABLE_TOUCH_LISTENER = false;
    ...
    public void setEnableDraggable(boolean enable) {
        if (draggableView != null) {
            draggableView.setTouchEnabled(enable);
            draggableView.setEnabled(enable);
        }
    }
