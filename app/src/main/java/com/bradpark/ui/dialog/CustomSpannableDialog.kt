...
import com.bradpark.calllback.CustomSpannableDialogStateCallback
 ...
 * @property matchText 구분 텍스트
 * @property matchColor 구분된 텍스트 색상
 * @property matchBold 구분된 텍스트 Bold 여부
 ...
 */
class CustomSpannableDialog(private val mContext: Context, private val mode: PjhConfig.PjhDialogType, private val buttonType: PjhConfig.PjhDialogButtonType, private val titleText: String = "", private val messageText: String = "",
                            private val matchText: String = "", private val matchColor: Int = Color.RED, private val matchBold: Boolean = false,
                            private val firstButtonText: String = "", private val secondButtonText: String = "", private val  thirdButtonText:String = "",
                            private val stateCallback: CustomSpannableDialogStateCallback, private val viewId: Int = 0, private val cancelable :Boolean = false,
    ...
    private fun setMessage() {
        mDataBinding?.let { binding ->
            if (messageText.isNotEmpty()) {
                ...
                binding.tvCubeDialogMessage.text = PjhUi.getSpannableStringBuilder(messageText,matchText, matchColor,matchBold)
